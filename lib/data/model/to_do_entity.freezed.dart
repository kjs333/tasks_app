...
mixin _$ToDoEntity {
 ...
 String get id; String get title; String? get description;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'is_favorite') bool get isFavorite;@JsonKey(name: 'is_done') bool get isDone;
...
@override
String toString() {
  return 'ToDoEntity(id: $id, title: $title, description: $description, createdAt: $createdAt, isFavorite: $isFavorite, isDone: $isDone)';
}
...
@useResult
$Res call({
 String id, String title, String? description,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'is_favorite') bool isFavorite,@JsonKey(name: 'is_done') bool isDone
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? description, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'is_favorite')  bool isFavorite, @JsonKey(name: 'is_done')  bool isDone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ToDoEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? description, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'is_favorite')  bool isFavorite, @JsonKey(name: 'is_done')  bool isDone)  $default,) {final _that = this;
switch (_that) {
case _ToDoEntity():
return $default(_that.id,_that.title,_that.description,_that.createdAt,_that.isFavorite,_that.isDone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String? description, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'is_favorite')  bool isFavorite, @JsonKey(name: 'is_done')  bool isDone)?  $default,) {final _that = this;
switch (_that) {
case _ToDoEntity() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.createdAt,_that.isFavorite,_that.isDone);case _:
  return null;
...
class _ToDoEntity implements ToDoEntity {
  const _ToDoEntity({required this.id, required this.title, required this.description, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'is_favorite') required this.isFavorite, @JsonKey(name: 'is_done') required this.isDone});
